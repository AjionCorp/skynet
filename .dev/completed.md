...
|------|------|--------|----------|-------|
| 2026-02-25 | [INFRA] [INFRA] Harden worktree lifecycle to prevent "worktree missing before gates" failures | merged to main | 9m | success |
| 2026-02-25 | [INFRA] [INFRA] Add per-mission backlog isolation in project-driver task generation | merged to main | 7m | success |
