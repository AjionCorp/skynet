...
# Prompt size guardrails (bytes). Warn at 150KB (~37K tokens), reject at 300KB (~75K tokens).
# Set to 0 to disable the respective check.
export SKYNET_PROMPT_WARN_BYTES="${SKYNET_PROMPT_WARN_BYTES:-150000}"
export SKYNET_PROMPT_MAX_BYTES="${SKYNET_PROMPT_MAX_BYTES:-300000}"
export SKYNET_MAX_FIX_ATTEMPTS="${SKYNET_MAX_FIX_ATTEMPTS:-3}"
export SKYNET_ORPHAN_BRANCH_AGE_DAYS="${SKYNET_ORPHAN_BRANCH_AGE_DAYS:-3}"  # days before orphaned dev/* branches are cleaned
